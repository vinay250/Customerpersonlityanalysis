...
def run_training_pipeline(data_path, model_path='E:/CustomerPersonalityAnalysis/artifacts/trained_model.pkl'):
    try:
        ...
        print(f"Exception occurred in the run_training_pipeline: {str(e)}")
